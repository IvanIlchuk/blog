...
$result = mysql_query("SELECT title,meta_d,meta_k,date,text FROM ink WHERE title='ink'",$db);
...
<?php
$result = mysql_query ("SELECT id,title,meta_d,meta_k,date,text FROM ink",$db);
