...
<?php include("blocks/nav.php");?> <!--Підключаємо панель навігації -->
  ...
  <!--<div id="menu">меню</div>-->
	...
	<?php
if (isset($page) && isset($title) && isset($date) && isset($meta_k) && isset($text) )

{
/*Тут можна заносити інформацію в базу*/
$result = mysql_query ("INSERT INTO statti (page,title,date,meta_k,text) VALUES 
('$page', '$title', '$date', '$meta_k', '$text')");
