...
/*$result = mysql_query("SELECT title,meta_d,meta_k,text FROM settings WHERE page='price'",$db);*/
$result = mysql_query("SELECT title,meta_d,meta_k,text FROM price WHERE page='price'",$db);
